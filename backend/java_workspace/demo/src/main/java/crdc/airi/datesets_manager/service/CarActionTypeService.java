...
import crdc.airi.datesets_manager.dao.CarActionTypeMapper;

@Service
public class CarActionTypeService {
	@Autowired
	private CarActionTypeMapper mapper;

	public int insert(String name, String description) throws Exception {
		return mapper.insert(name, description);
	}

	public CarActionType selectByName(String name) throws Exception {
		return mapper.selectByName(name);
	}

	public CarActionType selectById(int id) throws Exception {
		return mapper.selectById(id);
	}

	public List<CarActionType> selectAll() throws Exception {
