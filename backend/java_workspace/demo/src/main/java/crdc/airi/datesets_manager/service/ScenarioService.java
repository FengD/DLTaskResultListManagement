...
import crdc.airi.datesets_manager.dao.ScenarioMapper;
...
public class ScenarioService {
	...
	public Scenario selectByName(String name) throws Exception {
		return mapper.selectByName(name);
	}

	public Scenario selectById(int id) throws Exception {
		return mapper.selectById(id);
	}

	public List<Scenario> selectAll() throws Exception {
