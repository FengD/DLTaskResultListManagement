...
import crdc.airi.datesets_manager.dao.ApplicableSceneMapper;

@Service
public class ApplicableSceneService {
	@Autowired
	private ApplicableSceneMapper mapper;

	public int insert(String name, String description) throws Exception {
		return mapper.insert(name, description);
	}

	public ApplicableScene selectByName(String name) throws Exception {
		return mapper.selectByName(name);
	}

	public ApplicableScene selectById(int id) throws Exception {
		return mapper.selectById(id);
	}

	public List<ApplicableScene> selectAll() throws Exception {
