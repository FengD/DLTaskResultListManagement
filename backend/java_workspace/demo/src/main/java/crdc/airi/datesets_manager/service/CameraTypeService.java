...
import crdc.airi.datesets_manager.dao.CameraTypeMapper;

@Service
public class CameraTypeService {
	@Autowired
	private CameraTypeMapper mapper;

	public int insert(String name, String description) throws Exception {
		return mapper.insert(name, description);
	}

	public CameraType selectByName(String name) throws Exception {
		return mapper.selectByName(name);
	}

	public CameraType selectById(int id) throws Exception {
		return mapper.selectById(id);
	}

	public List<CameraType> selectAll() throws Exception {
