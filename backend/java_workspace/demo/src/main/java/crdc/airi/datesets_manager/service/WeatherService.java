...
import crdc.airi.datesets_manager.dao.WeatherMapper;
...
public class WeatherService {
	...
	public Weather selectByName(String name) throws Exception {
		return mapper.selectByName(name);
	}

	public Weather selectById(int id) throws Exception {
		return mapper.selectById(id);
	}

	public List<Weather> selectAll() throws Exception {
