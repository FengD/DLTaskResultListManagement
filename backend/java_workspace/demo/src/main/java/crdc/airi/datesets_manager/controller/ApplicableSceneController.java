...
import crdc.airi.datesets_manager.service.ApplicableSceneService;
import crdc.airi.datesets_manager.utils.Response;
import io.swagger.annotations.ApiOperation;

@RestController
@RequestMapping("ApplicableScene")
public class ApplicableSceneController {
	@Autowired
	private ApplicableSceneService service;

	@GetMapping("id/{id}")
	@ApiOperation(value = "ApplicableScene", notes = "get ApplicableScene by id")
	...
	@ApiOperation(value = "ApplicableScene", notes = "get ApplicableScene by name")
	...
	@GetMapping("")
	@ApiOperation(value = "ApplicableScene", notes = "get all ApplicableScene")
	...
	@PostMapping("")
	@ApiOperation(value = "ApplicableScene", notes = "insert ApplicableScene")
	...
	@DeleteMapping("{id}")
	@ApiOperation(value = "ApplicableScene", notes = "delete ApplicableScene by id")
	...
	@PutMapping("{id}")
	@ApiOperation(value = "ApplicableScene", notes = "update ApplicableScene by id")
