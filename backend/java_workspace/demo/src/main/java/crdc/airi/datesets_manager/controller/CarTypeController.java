...
import crdc.airi.datesets_manager.service.CarTypeService;
...
public class CarTypeController {
	...
	@GetMapping("id/{id}")
	@ApiOperation(value = "CarType", notes = "get CarType by id")
	...
	@ApiOperation(value = "CarType", notes = "get CarType by name")
	...
	@GetMapping("")
	@ApiOperation(value = "CarType", notes = "get all CarType")
	...
	@PostMapping("")
	@ApiOperation(value = "CarType", notes = "insert CarType")
	...
	@DeleteMapping("{id}")
	@ApiOperation(value = "CarType", notes = "delete CarType by id")
	...
	@PutMapping("{id}")
	@ApiOperation(value = "CarType", notes = "update CarType by id")
