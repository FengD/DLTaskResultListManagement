...
import crdc.airi.datesets_manager.service.TimeIntervalService;
...
public class TimeIntervalController {
	...
	@GetMapping("id/{id}")
	@ApiOperation(value = "TimeInterval", notes = "get TimeInterval by id")
	...
	@ApiOperation(value = "TimeInterval", notes = "get TimeInterval by name")
	...
	@GetMapping("")
	@ApiOperation(value = "TimeInterval", notes = "get all TimeInterval")
	...
	@PostMapping("")
	@ApiOperation(value = "TimeInterval", notes = "insert TimeInterval")
	...
	@DeleteMapping("{id}")
	@ApiOperation(value = "TimeInterval", notes = "delete TimeInterval by id")
	...
	@PutMapping("{id}")
	@ApiOperation(value = "TimeInterval", notes = "update TimeInterval by id")
